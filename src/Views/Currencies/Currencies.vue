  ...
  <section class=" dark:bg-gray-900 p-3 sm:p-5">
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tr class="border-b dark:border-gray-700">
              ...
              <td class=" py-3 text-center flex justify-center items-center">
                ...
                <RouterLink :to="{ path: '/currencies/update/' + currency.id }" href="#" class="me-3">
      ...
      <div v-if="pagination" class="flex justify-center items-center mt-10">
        <pagination :pagination="pagination" :get-data="getCurrencies" :per_page="10"></pagination>
      </div>
  ...
  methods: {
    ...
    debounceSearch() {
      ...
      this.debounceTimer = setTimeout(() => {
        this.getCurrencies(1, this.search);
      }, 500);
    },
  }
}
